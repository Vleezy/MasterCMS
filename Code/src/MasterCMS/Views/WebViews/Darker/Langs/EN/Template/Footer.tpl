        ...
        <footer>
        	<p id="Links"><a href="{@url}/web/terms">Terms and Conditions</a> | <a href="{@url}/web/cookies">Privacy Policy</a></p>
        	<p id="Copyright"><strong>&copy; {@name} Hotel</strong> · All rights reserved to their respective owners</p>
        	<p id="Devs">MasterCMS {@master_version} | Back-End: <b>Denzel Code (LxBlack)</b> | Front-End: <b>Yonier (HabboAdictos1)
          <!--<br>Marshmallow Emulator: Basado en Butterfly r96e codeado por <b>CarlosD y LoToS--></b></p>
        </footer>
