<main id="lg">
    <div class="container">
        <div class="row gutter-3">
            <div class="col-lg-4">
                ...
                <div class="Box">
                    ...
                    <div id="homeFooter">
                        ...
                        <p><strong>Motto: </strong> {@user_motto}</p>
                    </div>
                </div>
                <div class="Box">
                    <div class="boxTitle">Most recent photos</div>
            ...
            <div class="col-lg-8">
                <div class="Box">
                    <div class="boxTitle">Profile of {@user_username}</div>
                    <div class="boxContent">
                        <p>Welcome to my profile {@username}, here you can see my basic information in the hotel.</p>
                    </div>
                </div>
                <div class="Box">
                    <div class="boxTitle">Badges</div>
                    <div class="boxContent">
                        <ul id="badgeContainer">
                            <?php
                                ...
                                if ($this->con->num_rows($badges_Query) == 0) {
                                    ...
                                    echo '<p>{@user_username} Does not have badges yet</p>';
                ...
                <div class="Box">
                    <div class="boxTitle">My rooms</div>
                        ...
                        <ul id="hotRooms">
                            <?php
                                ...
                                if ($this->con->num_rows($room_query) == 0) {
                                    ...
                                    echo '<p class="text-center" style="margin-top: 5rem;">{@user_username} does not have rooms yet.</p>';
                            ...
                            ?>
                                    <li>
                                        ...
                                        <div class="hrUsers"><?php echo $room['users_now']; ?>/<?php echo $room['users_max']; ?> Users Inside</div>
                                    </li>
                            <?php  }  }  ?>
                        </ul>
                    </div>
