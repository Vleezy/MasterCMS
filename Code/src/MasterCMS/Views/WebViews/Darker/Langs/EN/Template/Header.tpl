	...
	<section id="Head">
		<header <?php if (!$this->users->getSession()) { echo 'id="noLogged"'; } else { echo 'id="Logged"'; } ?>>			
			<div class="container">
				...
				<?php if ($this->users->getSession()) { ?><div id="quickSection" class="hidden-sm-down"><?php if ($this->users->getSession() && in_array($this->users->get('rank'), $this->hotel->getMaster('all'))) { ?><a href="{@url}/hk">HouseKeeping</a> / <?php } ?><a href="{@url}/web/logout">Sign off</a></div><?php } ?>
		...
		<nav class="collapse" id="menu-list">
			<div class="container">
				...
				<ul id="menu-right">					
					...
					<li><a href="{@url}/web/community"><i class="fa fa-users icon" aria-hidden="true"></i>Community</a></li>
					<?php if ($this->users->getSession()) { ?>
					<li><a href="{@url}/web/team"><i class="fa fa-star" aria-hidden="true"></i>Team</a></li>
					<?php } ?>
					<li><a href="{@url}/web/news"><i class="fa fa-newspaper-o icon" aria-hidden="true"></i>News</a></li>
					<?php if (!$this->users->getSession()) { ?><li><a href="{@url}/web/register"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li><?php } ?>					
					...
					<?php if ($this->users->getSession()) { ?><li><a href="{@url}/web/logout" class="hidden-lg-up"><i class="fa fa-power-off" aria-hidden="true"></i>Sign off</a></li><?php } ?>
				</ul>
			</div>
		</nav>
	</section>
	<div class="parse">
		<?php if ($this->users->getSession()) { ?>
			...
			<nav id="sub-menu">
				<div class="container">
					<ul>
						...
						<li <?php if ($this->request->getMethod() == 'colaborators' && $this->request->getController() == 'web') { echo 'id="selected"'; } ?>><a href="{@url}/web/colaborators">Collaborators</a></li>
					</ul>
				</div>
			</nav>
			<?php } ?>
			...
			<nav id="sub-menu">
				<div class="container">
					<ul>
						<li <?php if ($this->request->getMethod() == 'index' && $this->request->getController() == 'web') { echo 'id="selected"'; } ?>><a href="/">Home</a></li>
						<li <?php if ($this->request->getMethod() == 'profile' && $this->request->getController() == 'web') { echo 'id="selected"'; } ?>><a href="{@url}/web/profile">My profile</a></li>
						<li <?php if ($this->request->getMethod() == 'settings' && $this->request->getController() == 'web') { echo 'id="selected"'; } ?>><a href="{@url}/web/settings">Configuration</a></li>
					</ul>
				</div>
			</nav>
			<?php } ?>
			...
			<nav id="sub-menu">
				<div class="container">
					<ul>
						<li <?php if ($this->request->getMethod() == 'community' && $this->request->getController() == 'web') { echo 'id="selected"'; } ?>><a href="{@url}/web/community"">Community</a></li>
