<main id="lg">
    <div class="container-fluid">
        <div class="row gutter-10">
                        ...
                        <li>
                            <div class="nSliderIMG" style="background:url('<?php echo $news_select['image']; ?>') center;">
                                ...
                                <div class="nSliderFoot">
                                    <button class="btn btn-success btn-lg"><a href="{@url}/web/news/<?php echo $news_select['id']; ?>">Go to News</a></button>                                    
                                </div>
                            </div>
                        </li>
                        <?php } ?>
            ...
            <div class="col-lg-6">
                <div class="Box">
                    <div class="boxTitle">Popular Rooms</div>
                        ...
                        <ul id="hotRooms">
                            ...
                            <li>
                                ...
                                <div class="hrInfo">
                                    ...
                                    <span>Room created by <?php echo $owner['username']; ?></span>
                                </div>
                                <div class="hrUsers"><?php echo $room['users_now']; ?>/<?php echo $room['users_max']; ?> Users In</div>
                            </li>
                            <?php } } ?>
                        </ul>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="Box">
                    <div class="boxTitle">User Random</div>
                    <div class="boxContent" style="height: 19rem;">
                        ...
                        <h5 class="text-center"><b><?php echo $this->con->num_rows("SELECT * FROM users"); ?></b> {@name}s Registered</h5>
                        <h6 class="text-center" style="margin-bottom: .1rem;">¡Hi I am <b><?php echo $user['username']; ?></b>!</h6>
            ...
            <div class="col-lg-4">
                <div class="Box">
                    <div class="boxTitle">Latest Updates</div>
