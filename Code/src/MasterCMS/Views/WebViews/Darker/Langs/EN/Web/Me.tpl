        ...
        <div class="row gutter-10">
            <div class="col-lg-12">
            	...
            	<div class="Box">
            		<div class="boxContent meBox">
	            		...
	            		<div id="me_c-1">
	            			<a href="{@client_url}" class="btn btn-success btn-lg btn-radius float-right">Play now</a>
	            		</div>
            		</div>
            	</div>
            </div>
	                        ...
	                        <li>
	                            <div class="nSliderIMG" style="background:url('<?php echo $news_select['image']; ?>') center;">
	                                ...
	                                <div class="nSliderFoot">
	                                    <button class="btn btn-success btn-lg"><a href="{@url}/web/news/<?php echo $news_select['id']; ?>">Go to the News</a></button>                                    
	                                </div>
	                            </div>
	                        </li>
	        <?php } ?>
	            		...
	            		<ul id="lastNews">
	            			...
	            			<li>
	            				...
	            				<div class="lastDetails">
	            					...
	            					<span class="float-right"><a href="{@url}/web/news/<?php echo $news_select['id']; ?>">Read more</a></span>
	            				</div>
	            			</li>
	            			<?php } ?>
	            		</ul>
            ...
            <div class="col-lg-7">
                <div class="Box">
		            ...
		            ?>
		            <label for="refers_link" class="control-label" id="tlll"><h3>Copy Link</h3></label>
	                <input type="text" class="form-control" id="refers_link" value="{@url}/web/register/{@id}" readonly="">
					<button class="formButton btn btn-success btn-lg btn-radius" id="ref_B" data-done="Link saved" style="margin-bottom: 1rem;">Copy Link</button>
					<p>You currently have <strong><?php echo $count_refers; ?></strong> refers<br>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>You have not set your username, what do you expect to do?</p>
					<form action="" method="POST" id="fbnameFormulary">
						...
						<i>Enter a username, for example: <strong><?php echo $this->facebook->getUser('first_name') . rand(0,9) . rand(0,9) . rand(0,9); ?></strong></i>
						<hr>
...
<div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-list"></i> List of awards</h3>
