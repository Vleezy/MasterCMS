            ...
            <div class="col-lg-4">
                <div class="Box">
                    ...
                    <div class="boxContent">
                        ...
                        <img src="{@cdn}/Images/avatarimage.png" align="right"> Make sure that everyday life in the hotel runs smoothly. They also take care of information, events and many other things of the hotel, so boredom disappears, if you have any questions or doubts, speak to one of these {@name}s!
                    </div>
                </div>
            </div>
        </div>
