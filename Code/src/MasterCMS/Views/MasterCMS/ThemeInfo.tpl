...
<head>
    ...
    <meta name="author" content="LxBlack & Yonier">
    <link rel="icon" type="image/png" href="{@master_cdn}/img/master.png" />
    <meta property="og:type" content="website">
    <meta property="og:title" content="{@name} tu diversión asegurada">
    <meta property="og:url" content="{@url}">
    <meta name="description" content="Informaciones del tema {@theme_name} de MasterCMS">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="{@name}">
    <meta property="og:title" content="{@name}">
    <meta property="og:description" content="Informaciones del tema {@theme_name} de MasterCMS">
    <meta property="og:url" content="{@url}" habbo-head-url="content">
    <meta property="og:image" content="{@master_cdn}/img/mastercms.png">
    <meta property="og:image:height" content="904">
    <meta property="og:image:width" content="289">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{@name}">
    <meta name="twitter:description" content="Informaciones del tema {@theme_name} de MasterCMS">
    <meta name="twitter:image" content="{@master_cdn}/img/mastercms.png">
    <meta itemprop="name" content="{@name}">
    <meta itemprop="description" content="Informaciones del tema {@theme_name} de MasterCMS">
    <meta itemprop="image" content="{@master_cdn}/img/mastercms.png">
...
<body id="body">
	<div class="title">
		<div class="sub_title">{@name} - <?php echo $title; ?></div>
	</div>
	<div class="bodyEs">
		<img src="{@master_cdn}/img/mastercms.png" title="MasterCMS">
		<ul>
